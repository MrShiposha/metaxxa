...
{
	template <typename... Arguments>
	class tuple_size<Tuple<Arguments...>> 
		: public std::integral_constant<size_t, Tuple<Arguments...>::size()>
	{};

	template <size_t INDEX, typename... Arguments>
	class tuple_element<INDEX, Tuple<Arguments...>>
	{
	public:
		using type = std::tuple_element_t<INDEX, typename Tuple<Arguments...>::StdTuple>;
	};
