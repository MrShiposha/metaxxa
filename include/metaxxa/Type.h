...
public:
	...
	using MoveTemplateTypes = metaxxa::detail::MoveTemplateTypes<TemplateType, SomeType>;

	template <template <typename...> typename TemplateType>
	using MoveTemplateTypesUnique = metaxxa::detail::MoveTemplateTypesUnique<TemplateType, SomeType>;

	template <template <typename...> typename TemplateType>
	using WrapToTemplateIfNotWrapped = typename metaxxa::detail::template WrapToTemplateIfNotWrapped<TemplateType, SomeType>::Result;
...
constexpr bool operator==(Type<FirstType>, Type<SecondType>);
